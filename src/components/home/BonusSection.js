...
const BonusSection = () => {
  return (
    <div className=" shadow-lg border max-w-[819px] mx-auto text-center rounded-lg py-[50px] px-[15px] sm:px-[50px] my-6">
      ...
      <img
        src="https://images.leadconnectorhq.com/image/f_webp/q_80/r_1200/u_https://assets.cdn.filesafe.space/3cfYZ62ndd3Fci44OcL9/media/659645bb8619066963ad4b25.png"
        alt=""
      />
      ...
      <p className="text-[18px] sm:text-[24px] text-start ml-[20px] sm:ml-[76px] max-w-[617px]">
      ...
      <div className="pb-[30px] border-b border-[#cbd5e0]">
        ...
        <img
          className="mt-2 sm:max-w-[600px] mx-auto"
      ...
      <div className="pb-[30px] border-b border-[#cbd5e0]">
        ...
        <img
          className="mx-auto"
          src="https://images.leadconnectorhq.com/image/f_webp/q_80/r_1200/u_https://assets.cdn.filesafe.space/3cfYZ62ndd3Fci44OcL9/media/658402ea53865c7cb09fa932.gif"
          alt=""
        />
        <div className=" py-2 mb-[20px] ">
          <h1 className=" text-[24px] sm:text-[30px] text-justify sm:max-w-[600px] tracking-[-1px] sm:leading-[36px] mx-auto relative">
            ...
            <span className="text-[18px] sm:text-[26px]">
              ...
              your life easier, these tools and resources have got you covered
      ...
      <div className="pb-[30px] border-b border-[#cbd5e0]">
        ...
        <img
          className="mx-auto max-w-[200px] sm:max-w-[350px]"
      ...
      <div className="pb-[30px] border-b border-[#cbd5e0]">
        ...
        <img
          className="mx-auto max-w-[200px] sm:max-w-[200px] sm:max-w-[350px]"
        ...
        <div className=" py-2 mb-[20px] ">
          <h1 className=" text-[24px] sm:text-[30px] text-justify sm:max-w-[600px] tracking-[-1px] sm:leading-[36px] mx-auto relative">
            ...
            <span className="text-[18px] sm:text-[26px]">
              ...
              <b>enjoying a happy and fulfilling life</b>{" "}
              <span className="underline">WITHOUT</span> burning out. No more
              24/7 hustle & grind!
            </span>
          </h1>
        </div>
      ...
      <div className="divide-y divide divide-black max-w-[659px] mx-auto">
        <h1 className="pt-5 text-[24px] text-start">
      ...
      <img
        src="https://images.leadconnectorhq.com/image/f_webp/q_80/r_1200/u_https://assets.cdn.filesafe.space/3cfYZ62ndd3Fci44OcL9/media/6583ffac3489e45ff6603e67.png"
        alt=""
      />
